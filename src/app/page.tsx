  ...
  return (
    <main className="min-h-screen bg-[#050810] text-white">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-4 text-center">
        ...
        <form action={async () => { "use server"; await signIn("github"); }} className="mt-10">
          <button
            type="submit"
            className="px-8 py-4 bg-[#00d4ff] text-[#050810] font-bold rounded-xl text-lg hover:brightness-110 transition flex items-center gap-3"
          >
            <GithubIcon />
            Sign in with GitHub ⚡
          </button>
