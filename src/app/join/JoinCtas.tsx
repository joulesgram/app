  ...
  return (
    <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
      ...
      >
        <button
          type="submit"
          onClick={() => trackConversion("join_cta_click", { cta: "signin_github", source: "join_page" })}
          className="px-8 py-4 bg-[#00d4ff] text-[#050810] font-bold rounded-xl text-lg hover:brightness-110 transition inline-flex items-center gap-3"
        >
          <GithubIcon />
          Sign in with GitHub
        </button>
